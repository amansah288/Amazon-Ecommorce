      ...
      <>
        <SafeAreaView style={styles.Container}>
          <ScrollView>
            ...
            {/* Delivery */}
            <Pressable
              onPress={() => setModalVisible(!modalVisibal)}
              style={{
                flexDirection: "row",
                gap: 5,
                alignItems: "center",
            ...
            <Text
              style={{ height: 1, borderColor: "#D0D0D0", borderWidth: 2 }}
            />

            <Text style={styles.TodayDeal}>Today's Deals</Text>
        ...
        <BottomModal
          onBackdropPress={() => setModalVisible(!modalVisibal)}
          ...
          onHardwareBackPress={() => setModalVisible(!modalVisibal)}
          visible={modalVisibal}
          onTouchOutside={() => setModalVisible(!modalVisibal)}
        >
